...
static void spice_marshall_msgc_display_set_params(SpiceMarshaller *m, SpiceMsgcDisplaySetParams *msg)
{
    SPICE_GNUC_UNUSED SpiceMarshaller *m2;
    SpiceMsgcDisplaySetParams *src;
    src = (SpiceMsgcDisplaySetParams *)msg;

    spice_marshaller_add_uint32(m, src->enable_jpeg);
    spice_marshaller_add_uint32(m, src->jpeg_quality);
    spice_marshaller_add_uint32(m, src->video_codec_type);
    spice_marshaller_add_uint32(m, src->video_mjpeg_quality);
    spice_marshaller_add_uint32(m, src->video_h264_preset);
    spice_marshaller_add_uint32(m, src->video_h264_keyint);
}
...
SpiceMessageMarshallers * spice_message_marshallers_get1(void)
{
    ...
    marshallers.msgc_display_set_params = spice_marshall_msgc_display_set_params;
