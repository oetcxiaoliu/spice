...
static uint8_t * parse_SerredirChannel_msg(uint8_t *message_start, uint8_t *message_end, uint16_t message_type, int minor, size_t *size_out, message_destructor_t *free_message)
{
    static parse_msg_func_t funcs1[7] =  {
        parse_msg_migrate,
        parse_SpiceMsgData,
...
static uint8_t * parse_ParredirChannel_msg(uint8_t *message_start, uint8_t *message_end, uint16_t message_type, int minor, size_t *size_out, message_destructor_t *free_message)
{
    static parse_msg_func_t funcs1[7] =  {
        parse_msg_migrate,
        parse_SpiceMsgData,
...
spice_parse_channel_func_t spice_get_server_channel_parser(uint32_t channel, unsigned int *max_message_type)
{
    static struct {spice_parse_channel_func_t func; unsigned int max_messages; } channels[12] =  {
        ...
        { parse_SerredirChannel_msg, 101},
        { parse_ParredirChannel_msg, 101}
    };
    if (channel < 12) {
