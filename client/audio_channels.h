...
public:
    ...
    void close_audio_player();
    void open_audio_player();
#endif
protected:
    virtual void on_disconnect();

private:
		void handle_set_volume(RedPeer::InMessage* message);
		void handle_set_mute(RedPeer::InMessage* message);
