...
void HotKeysParser::add_key(HotkeySet& keys, const char* key)
{
    ...
    static const struct {
        ...
        { "0", REDKEY_0, REDKEY_INVALID },
        { "1", REDKEY_1, REDKEY_INVALID },
        { "2", REDKEY_2, REDKEY_INVALID },
        { "3", REDKEY_3, REDKEY_INVALID },
        { "4", REDKEY_4, REDKEY_INVALID },
        { "5", REDKEY_5, REDKEY_INVALID },
        { "6", REDKEY_6, REDKEY_INVALID },
        { "7", REDKEY_7, REDKEY_INVALID },
        { "8", REDKEY_8, REDKEY_INVALID },
        { "9", REDKEY_9, REDKEY_INVALID },
        { "a", REDKEY_A, REDKEY_INVALID },
        { "b", REDKEY_B, REDKEY_INVALID },
        { "c", REDKEY_C, REDKEY_INVALID },
        { "d", REDKEY_D, REDKEY_INVALID },
        { "e", REDKEY_E, REDKEY_INVALID },
        { "f", REDKEY_F, REDKEY_INVALID },
        { "g", REDKEY_G, REDKEY_INVALID },
        { "h", REDKEY_H, REDKEY_INVALID },
        { "i", REDKEY_I, REDKEY_INVALID },
        { "j", REDKEY_J, REDKEY_INVALID },
        { "k", REDKEY_K, REDKEY_INVALID },
        { "l", REDKEY_L, REDKEY_INVALID },
        { "m", REDKEY_M, REDKEY_INVALID },
        { "n", REDKEY_N, REDKEY_INVALID },
        { "o", REDKEY_O, REDKEY_INVALID },
        { "p", REDKEY_P, REDKEY_INVALID },
        { "q", REDKEY_Q, REDKEY_INVALID },
        { "r", REDKEY_R, REDKEY_INVALID },
        { "s", REDKEY_S, REDKEY_INVALID },
        { "t", REDKEY_T, REDKEY_INVALID },
        { "u", REDKEY_U, REDKEY_INVALID },
        { "v", REDKEY_V, REDKEY_INVALID },
        { "w", REDKEY_W, REDKEY_INVALID },
        { "x", REDKEY_X, REDKEY_INVALID },
        { "y", REDKEY_Y, REDKEY_INVALID },
        { "z", REDKEY_Z, REDKEY_INVALID }
    };
