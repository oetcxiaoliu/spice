...
static uint8_t * parse_msgc_display_set_params(uint8_t *message_start, uint8_t *message_end, int minor, size_t *size, message_destructor_t *free_message)
{
    SPICE_GNUC_UNUSED uint8_t *pos;
    uint8_t *start = message_start;
    uint8_t *data = NULL;
    ...
    size_t mem_size;
    uint8_t *in, *end;
    SpiceMsgcDisplaySetParams *out;

    nw_size = 24;
    mem_size = sizeof(SpiceMsgcDisplaySetParams);
    ...
    end = data + sizeof(SpiceMsgcDisplaySetParams);
    in = start;

    out = (SpiceMsgcDisplaySetParams *)data;

    out->enable_jpeg = consume_uint32(&in);
    out->jpeg_quality = consume_uint32(&in);
    out->video_codec_type = consume_uint32(&in);
    out->video_mjpeg_quality = consume_uint32(&in);
    out->video_h264_preset = consume_uint32(&in);
    out->video_h264_keyint = consume_uint32(&in);
...
static uint8_t * parse_SerredirChannel_msgc(uint8_t *message_start, uint8_t *message_end, uint16_t message_type, int minor, size_t *size_out, message_destructor_t *free_message)
{
    static parse_msg_func_t funcs1[6] =  {
        parse_msgc_ack_sync,
        parse_SpiceMsgEmpty,
...
static uint8_t * parse_ParredirChannel_msgc(uint8_t *message_start, uint8_t *message_end, uint16_t message_type, int minor, size_t *size_out, message_destructor_t *free_message)
{
    static parse_msg_func_t funcs1[6] =  {
        parse_msgc_ack_sync,
        parse_SpiceMsgEmpty,
...
spice_parse_channel_func_t spice_get_client_channel_parser(uint32_t channel, unsigned int *max_message_type)
{
    static struct {spice_parse_channel_func_t func; unsigned int max_messages; } channels[12] =  {
        ...
        { parse_SerredirChannel_msgc, 101},
        { parse_ParredirChannel_msgc, 101}
    };
    if (channel < 12) {
